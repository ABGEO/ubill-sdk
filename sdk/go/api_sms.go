...
func (r ApiSendSMSRequest) Execute() (*SendSMSResponse, *http.Response, error) {
...
//
//	@return SendSMSResponse
func (a *SmsAPIService) SendSMSExecute(r ApiSendSMSRequest) (*SendSMSResponse, *http.Response, error) {
	var (
