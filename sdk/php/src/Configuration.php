...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.ubill.dev/v1';
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.1.7/PHP';
    ...
    {
        $report  = 'PHP SDK (ABGEO\UBill\Sdk) Debug Report:' . PHP_EOL;
