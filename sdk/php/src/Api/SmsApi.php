...
use ABGEO\UBill\Sdk\ApiException;
use ABGEO\UBill\Sdk\Configuration;
use ABGEO\UBill\Sdk\FormDataProcessor;
use ABGEO\UBill\Sdk\HeaderSelector;
use ABGEO\UBill\Sdk\ObjectSerializer;
...
class SmsApi
{
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ABGEO\UBill\Sdk\Model\SMSBalanceResponse',
                        $request,
                        $response,
                    );
            }
    ...
    public function getBrandNamesWithHttpInfo($body = null, string $contentType = self::contentTypes['getBrandNames'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ABGEO\UBill\Sdk\Model\BrandNamesResponse',
                        $request,
                        $response,
                    );
            }
    ...
    public function getDeliveryReportWithHttpInfo($smsID, $body = null, string $contentType = self::contentTypes['getDeliveryReport'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ABGEO\UBill\Sdk\Model\DeliveryReportResponse',
                        $request,
                        $response,
                    );
            }
     ...
     * @throws \ABGEO\UBill\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ABGEO\UBill\Sdk\Model\SendSMSResponse
     */
     ...
     * @throws \ABGEO\UBill\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ABGEO\UBill\Sdk\Model\SendSMSResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendSMSWithHttpInfo($sMSPayload = null, string $contentType = self::contentTypes['sendSMS'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\ABGEO\UBill\Sdk\Model\SendSMSResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\ABGEO\UBill\Sdk\Model\SendSMSResponse';
        $request = $this->sendSMSRequest($sMSPayload, $contentType);
